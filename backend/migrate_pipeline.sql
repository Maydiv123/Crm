-- Migration script to convert from JSON-based pipeline to normalized structure

-- Drop old pipelines table if it exists
DROP TABLE IF EXISTS pipelines;

-- Create new normalized pipelines table
